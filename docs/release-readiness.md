...
| 多场景任务编排         | 无独立 mega-router：Skill Routing + Tool Capability + Mode 复用                                                                                                                           | multi-scenario 脚本档 4/4（data/web/document/automation，§51 指标）                                     | —                                                                       | 真实档各 1 类实跑（见 eval/results/multi-scenario-real）         | web 场景用 loopback fixture（真实外网研究属 Browser Provider 范围）              |

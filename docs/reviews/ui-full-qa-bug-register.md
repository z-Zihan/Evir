...
| UIQA-003 | P2       | Visual evidence was too narrow                                                 | 358 Web/Desktop/theme/locale/viewport screenshots plus 6 baselines                                                                | Verified                   |
...
| UIQA-014 | P1       | Compact sidebar left unused space and settings retained a desktop-heavy layout | Sidebar fills ≤640px; settings uses a full-screen page selector at ≤900px or short heights; 390×844 and 900×500 regressions added | Verified                   |

...
/**
 * Vendored from vercel/ai-elements `packages/elements/src/confirmation.tsx`
 * (Apache-2.0). Adaptations from the upstream source:
 * - `@repo/shadcn-ui/*` imports mapped to Evir's `components/ui` (including
 *   the source-adopted shadcn Alert primitive);
 * - `ToolUIPart` state types come from the local ai-types shim;
 * - the upstream "Approved/Denied" string labels are passed through — Evir's
 *   adapters supply localized copy via children/props.
 */

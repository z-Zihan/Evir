...
test("every reachable settings page has no serious axe violations", async ({ page }, testInfo) => {
  ...
  // theme/language merged into personalization; extended group (users/
  // plugins/browser on desktop) moved to the nav tail (2026-09-11).
  const expectedCount = isDesktop(testInfo) ? 14 : 11;
